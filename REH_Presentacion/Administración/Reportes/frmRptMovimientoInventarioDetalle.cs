...
namespace REH_Presentacion.Administracion.Reportes
{
    ...
    /// </summary>
    public partial class frmRptMovimientoInventarioDetalle : frmBaseTrxDev
    {
        ...
        #region Eventos
        public frmRptMovimientoInventarioDetalle()
        {
            InitializeComponent();
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    string psTitulo = string.Format("EGRESOS DE INVENTARIO DEL {0} AL {1}. \n TIPO DE ÍTEMS: {2} \n CENTRO DE COSTO: {3} \n", dtpFechaInicial.DateTime.ToString("dd/MM/yyyy"), dtpFechaFinal.DateTime.ToString("dd/MM/yyyy"), cmbTipo.Text, cmbCentroCosto.Text);

                    xrptGeneral xrptGen = new xrptGeneral();
                    xrptGen.dt = dt;
                    xrptGen.Landscape = true;
        ...
        {
            string psQuery = string.Format("EXEC ADMSPMOVIMIENTOINVENTARIODETALLE '{0}','{1}','{2}','{3}'", dtpFechaInicial.DateTime, dtpFechaFinal.DateTime, cmbTipo.EditValue.ToString(), cmbCentroCosto.EditValue.ToString());
