    ...
    public partial class frmReporteInventario : frmBaseTrxDev
    {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    string psTitulo = string.Format("LISTADO DE KARDEX DE INVENTARIO. TIPO: {0}",cmbTipo.Text);
        ...
        {
            return loLogicaNegocio.goConsultaDataTable(string.Format("EXEC ADMSPINVENTARIO '{0}'", cmbTipo.EditValue.ToString()));
        }
