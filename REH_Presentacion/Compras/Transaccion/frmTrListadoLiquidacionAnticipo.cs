...
{
    public partial class frmTrListadoLiquidacionAnticipo : frmBaseTrxDev
    {
        ...
        /// </summary>
        public frmTrListadoLiquidacionAnticipo()
        {
            InitializeComponent();
        ...
        private void frmTrListadoOrdenPago_Load(object sender, EventArgs e)
        {
            ...
            bsDatos.DataSource = new List<SpListadoLiquidacionAnticipo>();
        ...
        private void rpiBtnShow_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                var poLista = (List<SpListadoLiquidacionAnticipo>)bsDatos.DataSource;
                if (piIndex >= 0)
                {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (pId != 0)
                {
                    ...
                    {
                        var msg = loLogicaNegocio.gsEliminarLiquidacionAnticipo(pId, clsPrincipal.gsUsuario, clsPrincipal.gsTerminal);
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            try
            {
                List<SpListadoLiquidacionAnticipo> poLista = (List<SpListadoLiquidacionAnticipo>)bsDatos.DataSource;
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(result))
                {
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        string msg = loLogicaNegocio.gActualizarEstadoLiquidacionAnticipo(poLista[piIndex].Id, Diccionario.Corregir, result, clsPrincipal.gsUsuario, clsPrincipal.gsTerminal);
        ...
        private void lListar()
        {
            ...
            var poObject = loLogicaNegocio.goListadoLiquidacionAnticipo(int.Parse(Tag.ToString().Split(',')[0]), clsPrincipal.gsUsuario, dtpFechaInicial.DateTime, dtpFechaFinal.DateTime);
            if (poObject != null)
            {
