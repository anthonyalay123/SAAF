...
namespace REH_Presentacion.Compras.Maestros
{
    /// <summary>
    /// Autor: Victor Arévalo
    /// Fecha: 06/10/2022
    /// Formulario para dato maestro "Grupo Pagos"
    /// </summary>
    public partial class frmMaGrupoPago : frmBaseDev
    {
        #region Variables
        clsNGrupoPago loLogicaNegocio;
        #endregion

        #region Eventos
        public frmMaGrupoPago()
        {
            InitializeComponent();
            loLogicaNegocio = new clsNGrupoPago();
        }
        ...
        /// <param name="e"></param>
        private void frmMaTipoRubro_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frmBusqueda pofrmBuscar = new frmBusqueda(dt) { Text = "Listado de Grupo Pago" };
