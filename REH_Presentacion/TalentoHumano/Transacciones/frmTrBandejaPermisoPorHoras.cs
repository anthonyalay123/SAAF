...
namespace REH_Presentacion.TalentoHumano.Transacciones
{
    ...
    /// </summary>
    public partial class frmTrBandejaPermisoHoras : frmBaseTrxDev
    {
        //clsNPermiso
        ...
        /// </summary>
        public frmTrBandejaPermisoHoras()
        {
                ...
                if (poCambios == true)
                {
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        for (int i = 0; i < poLista.Count; i++)
                        {
                            ...
                            {
                                var psMess = loLogicaNegocio.gsAprobar(poLista[i].Id, clsPrincipal.gsUsuario, clsPrincipal.gsUsuario, clsPrincipal.gsTerminal, int.Parse(Tag.ToString().Split(',')[0]));
                            }
                        }
                        lListar();
