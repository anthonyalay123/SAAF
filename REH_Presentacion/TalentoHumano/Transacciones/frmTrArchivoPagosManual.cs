...
{
    public partial class frmTrArchivoPagosManual : frmBaseTrxDev
    {

        clsNNomina loLogicaNegocio;
        bool pbCargado;

        public frmTrArchivoPagosManual()
        {
            InitializeComponent();
        ...
        private void frmTrArchivoPagos_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                clsComun.gLLenarCombo(ref cmbFormaPago, loLogicaNegocio.goConsultarComboFormaPago().Where(x=>x.Codigo ==  "TRA").ToList());
                clsComun.gLLenarCombo(ref cmbTipoIdentificacion, loLogicaNegocio.goConsultarComboTipoIdentificación(), true);
            ...
            try
            {
                ...
                if (lbEsValido())
                {
                    ...
                    poLista.Add(new SpGeneraPago
                    {
                        ...
                        CodigoTipoIdentificacion = cmbTipoIdentificacion.EditValue.ToString(),
                        Banco = cmbBanco.Text,
                        ...
                        IdPersona = 0,
                        NombreCompleto = clsComun.gRemoverCaracteresEspeciales(txtNombre.Text.Trim()),
        ...
        private bool lbEsValido()
        {
            ...
            {
                XtraMessageBox.Show("Ingrese la Identificación.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return false;
            }

            if (string.IsNullOrEmpty(txtNombre.Text.Trim()))
            {
                XtraMessageBox.Show("Ingrese el nombre.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return false;
            }
            ...
            if (cmbTipoIdentificacion.EditValue.ToString() == Diccionario.Seleccione)
            {
                XtraMessageBox.Show("Seleccione Tipo de Identificación.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return false;
            }
