...
{
    public partial class frmPaTipoComisionPermiso : frmBaseDev
    {
        clsNTipoComisionPermiso loLogicaNegocio = new clsNTipoComisionPermiso();
        public frmPaTipoComisionPermiso()
        {
            InitializeComponent();
        }

        private void frmPaTipoComisionPermiso_Load(object sender, EventArgs e)
        {
            clsComun.gLLenarCombo(ref cmbTipoComision, loLogicaNegocio.goConsultarComboTipoComision(), true);
            clsComun.gLLenarCombo(ref cmbTipoPermiso, loLogicaNegocio.goConsultarComboTipoPermiso(), true);
        ...
        {
            cmbTipoComision.ItemIndex = 0;
            cmbTipoPermiso.ItemIndex = 0;
            cmbEstado.ItemIndex = 0;
            chbDescuentoValorComision.Checked = false;
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                List<TipoComisionPermiso> poListaObject = loLogicaNegocio.goListarMaestro(txtDescripcion.Text.Trim());
                DataTable dt = new DataTable();

                dt.Columns.AddRange(new DataColumn[]
                                    {
                                    new DataColumn("TipoComisión"),
                                    new DataColumn("TipoPermiso"),
                ...
                poListaObject.ForEach(a =>
                {
                    ...
                    row["TipoComisión"] = a.CodigoTipoComision;
                    row["Estado"] = Diccionario.gsGetDescripcion(a.CodigoEstado);
                    row["TipoPermiso"] = a.CodigoTipoPermiso;
                ...
                {
                    cmbTipoComision.EditValue = poListaObject[pofrmBuscar.Index].CodCodigoTipoComision;
                    cmbTipoPermiso.EditValue = poListaObject[pofrmBuscar.Index].CodCodigoTipoPermiso;
                    lConsultar();
                }
        ...
        private void lConsultar()
        {
                ...
                var poObject = loLogicaNegocio.goBuscarMaestro(cmbTipoPermiso.EditValue.ToString(), cmbTipoComision.EditValue.ToString());
                if (poObject != null)
                {
                    cmbTipoComision.EditValue = poObject.CodigoTipoComision;
                    cmbTipoPermiso.EditValue = poObject.CodigoTipoPermiso;
                    cmbEstado.EditValue = poObject.CodigoEstado;
                    chbDescuentoValorComision.Checked = poObject.DescuentoValorComision;
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                TipoComisionPermiso poObject = new TipoComisionPermiso();


               
                poObject.CodigoEstado = cmbEstado.EditValue.ToString();
                poObject.Descripcion = txtDescripcion.Text.Trim();
                poObject.CodigoTipoComision = cmbTipoComision.EditValue.ToString();
                poObject.CodigoTipoPermiso = cmbTipoPermiso.EditValue.ToString();
                poObject.DescuentoValorComision = chbDescuentoValorComision.Checked;
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                if (!string.IsNullOrEmpty(txtCodigo.Text.Trim()))
                {
                    ...
                    {
                        loLogicaNegocio.gEliminarMaestro(cmbTipoPermiso.EditValue.ToString(), cmbTipoComision.EditValue.ToString(), clsPrincipal.gsUsuario, clsPrincipal.gsTerminal);
