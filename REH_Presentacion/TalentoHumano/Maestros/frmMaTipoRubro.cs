...
namespace REH_Presentacion.Maestros
{
    ...
    /// Fecha: 24/01/2020
    /// Formulario para dato maestro "Tipo Rubro"
    /// </summary>
    public partial class frmMaTipoRubro : frmBaseDev
    {
        #region Variables
        clsNTipoRubro loLogicaNegocio;
        #endregion

        #region Eventos
        public frmMaTipoRubro()
        {
            InitializeComponent();
            loLogicaNegocio = new clsNTipoRubro();
        }
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frmBusqueda pofrmBuscar = new frmBusqueda(dt) { Text = "Listado de Tipo Rubro" };
