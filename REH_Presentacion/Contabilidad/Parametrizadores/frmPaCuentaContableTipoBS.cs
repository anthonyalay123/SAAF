...
namespace REH_Presentacion.Parametrizadores
{
    ...
    /// </summary>
    public partial class frmPaCuentaContableTipoBS : frmBaseTrxDev
    {
        ...
        /// </summary>
        public frmPaCuentaContableTipoBS()
        {
            InitializeComponent();
        ...
        private void frmPaCuentaContable_Load(object sender, System.EventArgs e)
        {
            try
            {
                ...
                clsComun.gLLenarCombo(ref cmbRubro , loLogicaNegocio.goConsultarComboTipoBeneficioSocial(), true);
                lbCargado = true;
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                if (lbEsValido())
                {
                    var psResult = loLogicaNegocio.gbGuardarCuentaContableCentroCostoTipoBeneficioSocial(cmbCentroCosto.EditValue.ToString(), cmbRubro.EditValue.ToString(), txtCuentaContable.Text.Trim(), clsPrincipal.gsUsuario, clsPrincipal.gsTerminal);
        ...
        private bool lbEsValido()
        {
            ...
            {
                XtraMessageBox.Show("Seleccione Tipo Beneficio Social.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return false;
            }
        ...
        private void lCargarParametrizaciones()
        {
            ...
            DataTable dt = loLogicaNegocio.gdtConsultaParametrizacionesCentroCostoTipoBS();
        ...
        private void lCargaCuentaContableRubroCentroCosto()
        {
            ...
            {
                txtCuentaContable.Text = loLogicaNegocio.gsConsultarCuentaContableTipoBSCentroCosto(cmbRubro.EditValue.ToString(), cmbCentroCosto.EditValue.ToString());
                lConsultarNombreCuenta();
            }
        }
