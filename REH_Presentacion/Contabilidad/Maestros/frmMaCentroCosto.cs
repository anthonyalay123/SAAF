...
namespace REH_Presentacion.Maestros
{
    ...
    /// Fecha: 17/01/2020
    /// Formulario para dato maestro "Centro de Costo"
    /// </summary>
    public partial class frmMaCentroCosto : frmBaseDev
    {
        #region Variables
        clsNCentroCosto loLogicaNegocio;
        #endregion
        ...
        /// </summary>
        public frmMaCentroCosto()
        {
            InitializeComponent();
            loLogicaNegocio = new clsNCentroCosto();
        }
        ...
        /// <param name="e"></param>
        private void frmMaCentroCosto_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                if (lbEsValido())
                {
                    ...
                    poObject.Alias1 = txtAlias1.Text.Trim();
                    poObject.Alias2 = txtAlias2.Text.Trim();
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frmBusqueda pofrmBuscar = new frmBusqueda(dt) { Text = "Listado de Centro Costo" };
        ...
        private void lLimpiar()
        {
            ...
            txtAlias1.Text = string.Empty;
            txtAlias2.Text = string.Empty;
        ...
        private void lConsultar()
        {
            if(!string.IsNullOrEmpty(txtCodigo.Text.Trim()))
            {
                ...
                if (poObject != null)
                {
                    ...
                    txtAlias1.Text = poObject.Alias1;
                    txtAlias2.Text = poObject.Alias2;
                }
            }
        }
        #endregion
