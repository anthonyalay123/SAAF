...
{
    public partial class frmPaUsuarioAprobacionExcepcion : frmBaseDev
    {

        clsNUsuarioAprobacion loLogicaNegocio = new clsNUsuarioAprobacion();
        public frmPaUsuarioAprobacionExcepcion()
        {
            InitializeComponent();
        }
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                List<UsuarioAprobacion> poListaObject = loLogicaNegocio.goListarMaestroExcepcion(txtDescripcion.Text.Trim());
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(loLogicaNegocio.gsGuardarExcepcion(poObject)))
                {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                if (!string.IsNullOrEmpty(txtCodigo.Text.Trim()))
                {
                    ...
                    {
                        loLogicaNegocio.gEliminarMaestroExcepcion(txtCodigo.Text.Trim(), clsPrincipal.gsUsuario, clsPrincipal.gsTerminal);
        ...
        private void lConsultar()
        {
            if (!string.IsNullOrEmpty(txtCodigo.Text.Trim()))
            {
                var poObject = loLogicaNegocio.goBuscarMaestroExcepcion(txtCodigo.Text.Trim());
                if (poObject != null)
                {
