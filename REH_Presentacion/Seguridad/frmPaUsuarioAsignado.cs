...
{
    public partial class frmPaUsuarioAsignado : frmBaseTrxDev
    {
        BindingSource bsDatos = new BindingSource();
        clsNUsuarioAsignado loLogicaNegocio;
        public frmPaUsuarioAsignado()
        {
            InitializeComponent();
        ...
        private void frmPaUsuarioAsignado_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                clsComun.gLLenarCombo(ref cmbUsuarioAsignado, loLogicaNegocio.goConsultarComboUsuarioTodos(), true);
                clsComun.gLLenarCombo(ref cmbUsuarioPrincipal, loLogicaNegocio.goConsultarComboUsuario(), true);
                var estado = new[]
                        {
        ...
        private void lcolumnas()
        {
            ...
            dgvParametrizaciones.Columns["UsuarioAsi"].Caption = "Usuario de SAAF Asignado";
        }
