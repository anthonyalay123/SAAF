...
{
    public partial class frmPaEstado : frmBaseDev
    {

        clsNEstado loLogicaNegocio = new clsNEstado();
        ...
        private void frmPaEstado_Load(object sender, EventArgs e)
        {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                List<Estado> poListaObject = loLogicaNegocio.goListarMaestro(txtDescripcion.Text.Trim());
                ...
                poListaObject.ForEach(a =>
                {
                    ...
                    row["Código"] = a.Codigo;
                    // row["Descripción"] = Diccionario.gsGetDescripcion(a.CodigoEstado);
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Estado poObject = new Estado();
                if (txtCodigo != null)
                {
                    poObject.CodigoEstado = txtCodigo.Text.ToString();
                }
        ...
        private void lConsultar()
        {
            if (!string.IsNullOrEmpty(txtCodigo.Text.Trim()))
            {
                ...
                if (poObject != null)
                {
                    txtCodigo.Text = poObject.CodigoEstado;
