...
{
    public partial class frmPaTransaccion : frmBaseDev
    {
        clsNTransaccion loLogicaNegocio = new clsNTransaccion();


        public frmPaTransaccion()
        {
            InitializeComponent();
        }

        private void frmPaTransaccion_Load(object sender, EventArgs e)
        {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                List<PaTransaccion> poListaObject = loLogicaNegocio.goListarMaestro(txtDescripcion.Text.Trim());
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                PaTransaccion poObject = new PaTransaccion();
                ...
                poObject.CantidadAutorizacion = int.Parse(txtCantidadAutorizacion.Text);
        ...
        private void lConsultar()
        {
            if (!string.IsNullOrEmpty(txtCodigo.Text.Trim()))
            {
                ...
                if (poObject != null)
                {
                    ...
                    txtCantidadAutorizacion.EditValue = poObject.CantidadAutorizacion;
        ...
        private void lLimpiar()
        {
            ...
            txtCantidadAutorizacion.Text = string.Empty;
