...
{
    public partial class frmPaCanton : frmBaseDev
    {
        clsNCanton loLogicaNegocio = new clsNCanton();
        public frmPaCanton()
        {
            InitializeComponent();
        }
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                List<Canton> poListaObject = loLogicaNegocio.goListarMaestro(txtDescripcion.Text.Trim());
        ...
        private void lConsultar()
        {
            ...
            if (poObject != null)
            {
                ...
                cmbProvincia.EditValue = poObject.IdProvincia.ToString();
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                poObject.IdProvincia = Convert.ToInt32(cmbProvincia.EditValue.ToString());
