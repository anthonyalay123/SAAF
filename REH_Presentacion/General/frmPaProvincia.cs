...
{
    public partial class frmPaProvincia : frmBaseDev
    {
        clsNProvincia loLogicaNegocio = new clsNProvincia();
        public frmPaProvincia()
        {
            InitializeComponent();
        }

        private void frmPaProvincia_Load(object sender, EventArgs e)
        {
            clsComun.gLLenarCombo(ref cmbPais, loLogicaNegocio.goConsultarComboPais(), true);
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                List<Provincia> poListaObject = loLogicaNegocio.goListarMaestro(txtDescripcion.Text.Trim());
        ...
        private void lConsultar()
        {
            ...
            if (poObject != null)
            {
                ...
                cmbPais.EditValue = poObject.idPais.ToString();
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Provincia poObject = new Provincia();
                ...
                poObject.idPais = Convert.ToInt32(cmbPais.EditValue.ToString());
