...
{
    public partial class frmPaFeriado : frmBaseDev
    {
        clsNFeriado loLogicaNegocio = new clsNFeriado();
        ...
        private void frmPaFeriado_Load(object sender, EventArgs e)
        {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                List<Feriado> poListaObject = loLogicaNegocio.goListarMaestro(txtDescripcion.Text.Trim());
                DataTable dt = new DataTable();

                dt.Columns.AddRange(new DataColumn[]
                                    {
                                    new DataColumn("Código", typeof(int)),
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                    ...
                    poObject.FechaFeriado = Convert.ToDateTime(dtpFecha.EditValue);
                    poObject.Usuario = clsPrincipal.gsUsuario;
                    poObject.Terminal = string.Empty;
                    poObject.Fecha = DateTime.Now;

              var psResult=  loLogicaNegocio.gsGuardar(poObject);
                    ...
                    {
                        XtraMessageBox.Show(psResult, Diccionario.MsgTituloRegistroGuardado, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
        ...
        private void lConsultar()
        {
            if (!string.IsNullOrEmpty(txtCodigo.Text.Trim()))
            {
                ...
                if (poObject != null)
                {
                    ...
                    dtpFecha.EditValue = poObject.FechaFeriado;
