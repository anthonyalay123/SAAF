...
namespace REH_Presentacion.Cobranza.Reportes
{
    ...
    /// </summary>
    public partial class frmRpCarteraZona : frmBaseTrxDev
    {
        ...
        private void frmTrNomina_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //cmbZonas.Properties.ForceInitialize();
                //cmbZonas.Properties.PopulateColumns();
                //cmbZonas.Properties.Columns["Codigo"].Visible = false;
        ...
        private DataTable ldtValidaQuery()
        {
            ...
            return loLogicaNegocio.goConsultaDataTable(string.Format("EXEC COBSPCONSULTACARTERAZONA '{0}','{1}'", dtpFechaCorte.Value, psZonas));
        }
