...
namespace REH_Presentacion.Cobranza.Parametrizadores
{
    ...
    /// </summary>
    public partial class frmPrExcepcionFacturaComision : frmBaseTrxDev
    {
        #region Variables
        ...
        /// </summary>
        public frmPrExcepcionFacturaComision()
        {
            InitializeComponent();
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(psMsgValida))
                {
                    ...
                    {
                        string psMsg = loLogicaNegocio.gsGuardarFacturaComision(poLista, clsPrincipal.gsUsuario, clsPrincipal.gsTerminal);
        ...
        { 
            bsDatos.DataSource = loLogicaNegocio.goConsultarExcepcionFacturaComision();
            gcDatos.DataSource = bsDatos;
