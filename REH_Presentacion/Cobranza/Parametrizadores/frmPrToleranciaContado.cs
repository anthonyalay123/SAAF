...
namespace REH_Presentacion.Cobranza.Parametrizadores
{
    ...
    /// </summary>
    public partial class frmPrToleranciaContado : frmBaseTrxDev
    {
        #region Variables
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    List<ToleranciaContado> poLista = (List<ToleranciaContado>)bsDatos.DataSource;
                    ...
                    {
                        string psMsg = loLogicaNegocio.gsGuardarToleranciaContado(poLista, clsPrincipal.gsUsuario, clsPrincipal.gsTerminal);
        ...
        private void rpiBtnDel_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                var poLista = (List<ToleranciaContado>)bsDatos.DataSource;
        ...
        private string lsEsValido()
        {
            ...
            //var poListaRecorrida = new List<ToleranciaContado>();
            //int fila = 1;
        ...
        private void lCargarEventosBotones()
        {
            ...
            bsDatos.DataSource = new List<ToleranciaContado>();
            ...
            //dgvDatos.Columns["CodigoToleranciaContado"].OptionsColumn.AllowEdit = false;

            dgvDatos.Columns["CodigoToleranciaContado"].Caption = "Código";
            dgvDatos.Columns["Descripcion"].Caption = "Código";
            dgvDatos.Columns["Desde"].Caption = "Desde";
            dgvDatos.Columns["Hasta"].Caption = "Hasta";
        ...
        { 
            bsDatos.DataSource = loLogicaNegocio.goConsultarPrToleranciaContado();
            gcDatos.DataSource = bsDatos;
