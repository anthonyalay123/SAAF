...
namespace REH_Presentacion.Cobranza.Parametrizadores
{
    ...
    /// </summary>
    public partial class frmPrClientePagoAseguradora : frmBaseTrxDev
    {
        #region Variables
        ...
        /// </summary>
        public frmPrClientePagoAseguradora()
        {
            InitializeComponent();
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    List<ClientePagoAseguradora> poLista = (List<ClientePagoAseguradora>)bsDatos.DataSource;
                    ...
                    {
                        string psMsg = loLogicaNegocio.gsGuardarClientePagoAseguradora(poLista, clsPrincipal.gsUsuario, clsPrincipal.gsTerminal);
        ...
        private void rpiBtnDel_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                var poLista = (List<ClientePagoAseguradora>)bsDatos.DataSource;
        ...
        private void btnAddManualmente_Click(object sender, EventArgs e)
        {
            ...
            {
                bsDatos.AddNew();
                ((List<ClientePagoAseguradora>)bsDatos.DataSource).LastOrDefault().CardCode = Diccionario.Seleccione;
                dgvDatos.Focus();
        ...
        private string lsEsValido()
        {
            ...
            var poListaRecorrida = new List<ClientePagoAseguradora>();
            int fila = 1;
        ...
        private void lCargarEventosBotones()
        {
            ...
            bsDatos.DataSource = new List<ClientePagoAseguradora>();
            ...
            dgvDatos.Columns["IdClientePagoAseguradora"].Visible = false;
            ...
            dgvDatos.Columns["CardCode"].Width = 580;
        }

        private void lBuscar()
        { 
            bsDatos.DataSource = loLogicaNegocio.goConsultarClientePagoAseguradora();
            gcDatos.DataSource = bsDatos;
