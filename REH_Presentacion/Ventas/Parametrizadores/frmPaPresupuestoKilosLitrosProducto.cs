...
{
    public partial class frmPaPresupuestoKilosLitrosProducto : frmBaseTrxDev
    {
        ...
        public frmPaPresupuestoKilosLitrosProducto()
        {
            InitializeComponent();
        ...
        private void btnPlantilla_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (lbCargado)
                {
                    ...
                    bs.DataSource = new List<PresupuestoKilosLitrosProductoExcel>();
                    dgv.BestFitColumns();
            ...
            try
            {
                ...
                if (ofdRuta.ShowDialog() == DialogResult.OK)
                {
                    if (!ofdRuta.FileName.Equals(""))
                    {
                        ...
                        var poLista = (List<PresupuestoKilosLitrosProductoGrid>)bsDatos.DataSource;
                        var poListaImportada = new List<PresupuestoKilosLitrosProductoGrid>();
                        ...
                        foreach (DataRow item in dt.Rows)
                        {
                            ...
                            {
                                PresupuestoKilosLitrosProductoGrid poItem = new PresupuestoKilosLitrosProductoGrid();
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                List<PresupuestoKilosLitrosProductoGrid> poLista = (List<PresupuestoKilosLitrosProductoGrid>)bsDatos.DataSource;

                if (poLista.Count > 0)
                {
                    string psMsg = loLogicaNegocio.gsGuardarProducto(poLista, clsPrincipal.gsUsuario, clsPrincipal.gsTerminal);
                    if (string.IsNullOrEmpty(psMsg))
                    {
        ...
        private void lCargarEventosBotones()
        {
            ...
            bsDatos.DataSource = new List<PresupuestoKilosLitrosProductoGrid>();
            gcParametrizaciones.DataSource = bsDatos;
            dgvParametrizaciones.Columns["IdPresupuestoKilosLitrosProducto"].Visible = false;
        ...
        private void lBuscar()
        {
            ...
            if (!string.IsNullOrEmpty(txtAnio.Text))
            {
                ...
                var poLIsta = loLogicaNegocio.goConsultarParametrizacionesProducto(piPeriodo);
                bsDatos.DataSource = poLIsta;
                gcParametrizaciones.DataSource = poLIsta;
            }
            else
            {
                var poLIsta = new List<PresupuestoKilosLitrosProductoGrid>();
                bsDatos.DataSource = poLIsta;
                gcParametrizaciones.DataSource = poLIsta;
            }
        ...
        private void btnAddFila_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(psMsgValida))
                {
                    ...
                    var poLista = (List<PresupuestoKilosLitrosProductoGrid>)bsDatos.DataSource;
                    var poListaAgregar = new List<PresupuestoKilosLitrosProductoGrid>();
                    PresupuestoKilosLitrosProductoGrid poItem = new PresupuestoKilosLitrosProductoGrid();
        ...
        private string lsValidaDuplicados(List<PresupuestoKilosLitrosProductoGrid> toListaGrid, List<PresupuestoKilosLitrosProductoGrid> toListaInsertar)
        {
            string psMsg = string.Empty;
