...
namespace REH_Presentacion.Ventas.Reportes
{
    ...
    /// Formulario
    /// </summary>
    public partial class frmRpCierreVentasBck : frmBaseTrxDev
    {
        ...
        private DataTable ldtValidaQuery()
        {
            ...
            if (cmbTipoReporte.EditValue.ToString() == "D")
            {
                ...
                psQuery = string.Format("EXEC VTASPPRESUPUESTOVENTAORGANICOCLIENTE '{0}', '{1}','1', '0', '0', '{2}'", pdDesde, dtpFechaInicial.DateTime, cmbTipo.EditValue.ToString());
            }
            else
            {
                psQuery = string.Format("EXEC VTASPPRESUPUESTOVENTAORGANICOCLIENTE '{0}', '{1}','0', '0', '0', '{2}'", dtpFechaInicial.DateTime, dtpFechaFinal.DateTime, cmbTipo.EditValue.ToString());
            }
