...
{
    public partial class frmRpCierreVentasInterno : frmBaseTrxDev
    {
        ...
        #region Eventos
        public frmRpCierreVentasInterno()
        {
            InitializeComponent();
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    subtitulo = string.Format(" GV - CICLO CORTO, SIERRA Y FLORES");
                }
                else
                {
        ...
        private DataTable ldtValidaQuery()
        {
            ...
            if (cmbTipoReporte.EditValue.ToString() == "D")
            {
                ...
                psQuery = string.Format("EXEC VTASPCIERREVENTASINTERNO '{0}', '{1}','1', '0', '0', '{2}'", pdDesde, dtpFechaInicial.DateTime, cmbTipo.EditValue.ToString());
            }
            else
            {
                psQuery = string.Format("EXEC VTASPCIERREVENTASINTERNO '{0}', '{1}','0', '0', '0', '{2}'", dtpFechaInicial.DateTime, dtpFechaFinal.DateTime, cmbTipo.EditValue.ToString());
            }
