...
namespace REH_Presentacion.Ventas.Reportes
{
    ...
    /// </summary>
    public partial class frmRpCumplimientoKilosLitrosGrupo : frmBaseTrxDev
    {
        ...
        #region Eventos
        public frmRpCumplimientoKilosLitrosGrupo()
        {
            InitializeComponent();
        ...
        {
            return loLogicaNegocio.goConsultaDataTable(string.Format("EXEC [dbo].[VTA_SP_CUMPLIMIENTO_KILOS_LITROS_X_GRUPO_AF] '{0}', '{1}'", dtpFechaInicial.Value, dtpFechaFinal.Value));
        }
        ...
        private void lBuscar()
        {
            ...
            if (lbEsValido())
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    //gridBandIni.Columns.Add(dgvDatos.Columns[0]); // ItemCode
                    //gridBandIni.Columns.Add(dgvDatos.Columns[1]); // Item
                    //gridBandIni.Columns.Add(dgvDatos.Columns[2]); // Grupo
                    //gridBandIni.Columns.Add(dgvDatos.Columns[3]); // Stock K/L
                    gridBandIni.Columns.Add(dgvDatos.Columns[0]); // Grupo
                    gridBandIni.Columns.Add(dgvDatos.Columns[1]); // Stock K/L
                    acum = 2;
