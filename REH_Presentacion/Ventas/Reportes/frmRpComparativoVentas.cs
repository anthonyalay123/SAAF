...
{
    public partial class frmRpComparativoVentas : frmBaseTrxDev
    {
        ...
        {
            string psQuery = string.Format("EXEC VTASPCOMPARATIVOVENTAS '{0}', '{1}', '{2}'", dtpFechaInicial.DateTime, dtpFechaFinal.DateTime, cmbTipo.EditValue.ToString());
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var dsVal = loLogicaNegocio.goConsultaDataSet(string.Format("EXEC VTASPCOMPARATIVOVENTAS '{0}', '{1}', '{2}'", dtpFechaInicial.DateTime, dtpFechaFinal.DateTime, cmbTipo.EditValue.ToString()));
                var msgVal = "";
