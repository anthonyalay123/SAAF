...
{
    public partial class frmRpCierreVentasInternoBck : frmBaseTrxDev
    {
        ...
        #region Eventos
        public frmRpCierreVentasInternoBck()
        {
            InitializeComponent();
        ...
        private void frmRpCierreVentasInterno_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var dsVal = loLogicaNegocio.goConsultaDataSet(string.Format("EXEC [dbo].[VTASPPRESUPUESTOVENTAORGANICOCLIENTEINTERNO] '{0}','{1}','0','0','1'", dtpFechaInicial.DateTime, dtpFechaFinal.DateTime));
                var msgVal = "";
                ...
                {
                    subtitulo = string.Format(" GV - {0}", cmbTipo.Text);
                }
                ...
                if (cmbTipoReporte.EditValue.ToString() == "D") {
                    ...
                    string lsTituloReporte = "{0}, {1} de {2} del {3} - {4}";
                    var psParametro1 = string.Format(lsTituloReporte, clsComun.gsGetDia(pdFecha), pdFecha.Day, clsComun.gsGetMes(pdFecha.Month).ToLower(), pdFecha.Year, cmbTipo.Text);
                ...
                } else
                {
                    ...
                    var psParametro1 = string.Format("CIERRE DE VENTAS DESDE {0} A {1} - {2}", fechaInicial, fechaFinal, cmbTipo.Text);
        ...
        private DataTable ldtValidaQuery()
        {
            ...
            if (cmbTipoReporte.EditValue.ToString() == "D")
            {
                ...
                psQuery = string.Format("EXEC VTASPPRESUPUESTOVENTAORGANICOCLIENTEINTERNO '{0}', '{1}','1', '0', '0', '{2}'", pdDesde, dtpFechaInicial.DateTime, cmbTipo.EditValue.ToString());
            }
            else
            {
                psQuery = string.Format("EXEC VTASPPRESUPUESTOVENTAORGANICOCLIENTEINTERNO '{0}', '{1}','0', '0', '0', '{2}'", dtpFechaInicial.DateTime, dtpFechaFinal.DateTime, cmbTipo.EditValue.ToString());
            }
