...
{
    public partial class frmRpComparativoVentasBck : frmBaseTrxDev
    {
        ...
        public frmRpComparativoVentasBck()
        {
            InitializeComponent();
            loLogicaNegocio = new clsNGestorConsulta();
        }

        private void frmRpComparativoVentas_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            string psQuery = string.Format("EXEC VTASPCOMPARATIVOVENTASBCK '{0}', '{1}', '{2}'", dtpFechaInicial.DateTime, dtpFechaFinal.DateTime, cmbTipo.EditValue.ToString());
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var dsVal = loLogicaNegocio.goConsultaDataSet(string.Format("EXEC VTASPCOMPARATIVOVENTASBCK '{0}', '{1}', '{2}'", dtpFechaInicial.DateTime, dtpFechaFinal.DateTime, cmbTipo.EditValue.ToString()));
                var msgVal = "";
