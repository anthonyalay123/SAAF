...
namespace REH_Presentacion.Ventas.Reportes
{
    ...
    /// </summary>
    public partial class frmRpCumplimientoKilosLitrosPresentacion : frmBaseTrxDev
    {
        ...
        #region Eventos
        public frmRpCumplimientoKilosLitrosPresentacion()
        {
            InitializeComponent();
        ...
        {
            return loLogicaNegocio.goConsultaDataTable(string.Format("EXEC [dbo].[VTA_SP_CUMPLIMIENTO_KILOS_LITROS_X_PRESENTACION_AF] '{0}', '{1}'", dtpFechaInicial.Value, dtpFechaFinal.Value));
        }
        ...
        private void lBuscar()
        {
            ...
            if (lbEsValido())
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    gridBandIni.Columns.Add(dgvDatos.Columns[0]); // Familia
                    gridBandIni.Columns.Add(dgvDatos.Columns[1]); // Grupo
                    gridBandIni.Columns.Add(dgvDatos.Columns[2]); // Item Code
                    gridBandIni.Columns.Add(dgvDatos.Columns[3]); // Item
                    gridBandIni.Columns.Add(dgvDatos.Columns[4]); // Tipo SKU
                    gridBandIni.Columns.Add(dgvDatos.Columns[5]); // Stock K/L
                    acum = 6;
