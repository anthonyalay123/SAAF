...
namespace REH_Presentacion.Ventas.Reportes
{
    ...
    /// </summary>
    public partial class frmRpDevolucionesMotivoZona : frmBaseTrxDev
    {
        ...
        #region Eventos
        public frmRpDevolucionesMotivoZona()
        {
            InitializeComponent();
            ...
            try
            {
                if (lbEsValido())
                {
                    ...
                    if (dt1.Rows.Count > 0)
                    {
                        ...
                        xrptDevolucionesMotivoZona xrpt = new xrptDevolucionesMotivoZona();
                        ...
                        //xrptDevolucionesMotivoZona2 xrpt1 = new xrptDevolucionesMotivoZona2();
                        //xrpt1.liMesMaximo = dtpFechaFinal.Value.Month;
                        //xrpt1.liMesMinimo = dtpFechaInicial.Value.Month;
                        ////Se establece el origen de datos del reporte (El dataset previamente leído)
                        //xrpt1.Parameters["Parameter1"].Value = psParametro1;
                        //xrpt1.DataSource = ds1;
                        ////Se invoca la ventana que muestra el reporte.
                        //xrpt1.RequestParameters = false;
                        //xrpt1.Parameters["Parameter1"].Visible = false;


                        //using (ReportPrintTool printTool = new ReportPrintTool(xrpt1))
                        //{
                        //    printTool.ShowRibbonPreviewDialog();
                        //}

                        //xrptDevolucionesMotivoZona3 xrpt2 = new xrptDevolucionesMotivoZona3();
                        //xrpt2.liMesMaximo = dtpFechaFinal.Value.Month;
                        //xrpt2.liMesMinimo = dtpFechaInicial.Value.Month;
                        ////Se establece el origen de datos del reporte (El dataset previamente leído)
                        //xrpt2.Parameters["Parameter1"].Value = psParametro1;
                        //xrpt2.DataSource = ds1;
                        ////Se invoca la ventana que muestra el reporte.
                        //xrpt2.RequestParameters = false;
                        //xrpt2.Parameters["Parameter1"].Visible = false;


                        //using (ReportPrintTool printTool = new ReportPrintTool(xrpt2))
                        //{
                        //    printTool.ShowRibbonPreviewDialog();
                        //}
                    }
        ...
        {
            return loLogicaNegocio.goConsultaDataTable(string.Format("EXEC [dbo].[VTASPCONSULTADEVOLUCIONESPORMOTIVOYZONA] '{0}', '{1}', {2}", dtpFechaInicial.Value, dtpFechaFinal.Value, cmbZonas.EditValue));
        }
