...
{
    public partial class frmTrBandejaCobranzaRebateAnual : frmBaseTrxDev
    {
        ...
        public frmTrBandejaCobranzaRebateAnual()
        {
            InitializeComponent();
            ...
            try
            {
                ...
                if (poLista.Count() > 0)
                {
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        {
                            var psMess = loLogicaNegocio.gsActualizaNCCobranzaRebateAnual(item.Id, clsPrincipal.gsUsuario, clsPrincipal.gsTerminal);
        ...
        private void lListar()
        {
            ...
            var poObject = loLogicaNegocio.goListarBandejaCobranzaRebateAnual();
            //if (poObject != null)
            //{
