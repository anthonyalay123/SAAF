...
{
    public partial class frmMaItemEPP : frmBaseDev
    {
        #region Variables
        clsNItem loLogicaNegocio = new clsNItem();
        #endregion
        ...
        private void frmMaItemEPP_Load(object sender, EventArgs e)
        {
            ...
            clsComun.gLLenarCombo(ref cmbTipo, loLogicaNegocio.goConsultarComboTipoItemEPP(), false);
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                if (!string.IsNullOrEmpty(txtCodigo.Text.Trim()))
                {
                    ...
                    {
                        var psMsg = loLogicaNegocio.gEliminarMaestro(int.Parse(txtCodigo.Text.Trim()), clsPrincipal.gsUsuario, clsPrincipal.gsTerminal);
                        if (psMsg == "")
                        {
        ...
        private void lConsultar()
        {
            if (!string.IsNullOrEmpty(txtCodigo.Text.Trim()))
            {
                ...
                if (poObject != null)
                {
                    ...
                    cmbTipo.EditValue = poObject.Tipo;
