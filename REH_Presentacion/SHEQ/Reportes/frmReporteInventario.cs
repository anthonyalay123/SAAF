...
namespace REH_Presentacion.SHEQ.Reportes
{
    ...
    /// </summary>
    public partial class frmReporteInventario : frmBaseTrxDev
    {
        ...
        private void frmTrNomina_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                clsComun.gLLenarCombo(ref cmbBodega, loLogicaNegocio.goConsultarComboBodegaEPP(), false,false, "TODOS");
                ...
                if(clsPrincipal.gbSuperUsuario == true) cmbBodega.Properties.ReadOnly = false;
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    string psTitulo = string.Format("LISTADO DE KARDEX DE INVENTARIO. TIPO: {0}",cmbBodega.Text.ToString());

                    xrptGeneral xrptGen = new xrptGeneral();
                    xrptGen.dt = dt;
                    xrptGen.Landscape = lbLandSpace;
                    xrptGen.Parameters["parameter1"].Value = psTitulo;
        ...
        {
            return loLogicaNegocio.goConsultaDataTable(string.Format("EXEC SHESPINVENTARIO '{0}'", cmbBodega.EditValue));
        }
