...
namespace REH_Presentacion.SHEQ.Reportes
{
    ...
    /// </summary>
    public partial class frmRptMovimientoInventarioEPP : frmBaseTrxDev
    {
        ...
        #region Eventos
        public frmRptMovimientoInventarioEPP()
        {
            InitializeComponent();
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var ds = loLogicaNegocio.goConsultaDataSet(string.Format("EXEC SHESPMOVIMIENTOINVENTARIO '{0}','{1}'",dtpFechaInicial.DateTime, dtpFechaFinal.DateTime));
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    xrpt.DataSource = ds;
                    xrpt.Parameters["parameter1"].Value = string.Format("LISTADO DE MOVIMIENTOS DEL {0} AL {1}", dtpFechaInicial.DateTime.ToString("dd/MM/yyyy"), dtpFechaFinal.DateTime.ToString("dd/MM/yyyy"));
        ...
        {
            string psQuery = string.Format("EXEC SHESPMOVIMIENTOINVENTARIO '{0}','{1}'", dtpFechaInicial.DateTime, dtpFechaFinal.DateTime);
