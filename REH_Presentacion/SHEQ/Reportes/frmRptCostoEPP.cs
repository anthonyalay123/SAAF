...
{
    public partial class frmRptCostoEPP : frmBaseTrxDev
    {
        ...
        public frmRptCostoEPP()
        {
            InitializeComponent();
            cmbTipo.EditValueChanged += cmbTipo_EditValueChanged;
        }

        private void frmRptCostoEPP_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (lbEsValido())
                {
                    ...
                    if (poLista != null && poLista.Rows.Count > 0)
                    {
                        ...
                        clsComun.gSaveFile(gcDatos, "COSTO DE EPP_" + cmbTipo.Text + "_" + fechaInicial + "_" + fechaFinal + ".xlsx", psFilter);
                    }
                    else
                    {
        ...
        private void lBuscar()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                else if (cmbTipo.EditValue.ToString() == "CEC" || cmbTipo.EditValue.ToString() == "ITE")
                {
        ...
        private DataTable ldtValidaQuery()
        {
            ...
            string psQuery = string.Format("EXEC SHESPCOSTOEPP '{0}','{1}','{2}'", fechaInicial, fechaFinal, cmbTipo.EditValue.ToString());
