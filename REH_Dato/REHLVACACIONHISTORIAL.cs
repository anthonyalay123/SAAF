...
namespace REH_Dato
{
    ...
    public partial class REHLVACACIONHISTORIAL
    {
        ...
        public Nullable<int> DiasGozadosPorLiq { get; set; }
        public Nullable<int> DiasLiqPorGozar { get; set; }
        public Nullable<int> IdNomina { get; set; }
        public Nullable<decimal> SaldoDiasDec { get; set; }
    }
}
