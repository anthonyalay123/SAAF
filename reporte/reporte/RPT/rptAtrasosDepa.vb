...
Public Class rptAtrasosDepa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "reporte.rptAtrasosDepa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAtrasosDepa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAtrasosDepa = New rptAtrasosDepa()
        rpt.Site = Me.Site
        Return rpt
    End Function
